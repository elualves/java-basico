...
public class Vetor009MultiplicaElementoDeUmVetorPeloElementoDeOutroVetor {

		public static void main(String[] args) {
			/*
			 *Multiplica os elementos de um vetor pelos elementos de outro vetor, c[i]=a[i]*b[i].
			 */
